...
class WPSFramework_Option_background extends WPSFramework_Options {
	...
	public function output() {
		...
		$button_title = (isset ( $button_title )) ? $button_title : esc_html__ ( 'Upload', 'our-team-members' );
		$frame_title = (isset ( $frame_title )) ? $frame_title : esc_html__ ( 'Upload', 'our-team-members' );
		$insert_title = (isset ( $insert_title )) ? $insert_title : esc_html__ ( 'Use Image', 'our-team-members' );
