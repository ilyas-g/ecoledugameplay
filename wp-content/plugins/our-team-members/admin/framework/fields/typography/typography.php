...
class WPSFramework_Option_typography extends WPSFramework_Options {
	...
	public function output() {
		...
		if (is_object ( $google_json )) {
			...
			echo '<optgroup label="' . esc_html__ ( 'Web Safe Fonts', 'our-team-members' ) . '">';
			...
			echo '<optgroup label="' . esc_html__ ( 'Google Fonts', 'our-team-members' ) . '">';
			...
			echo esc_html__ ( 'Error! Can not load json file.', 'our-team-members' );
		}
