...
class WPSFramework_Option_icon extends WPSFramework_Options {
	...
	public function output() {
		...
		echo '<a href="#" class="button button-primary wpsf-icon-add">' . esc_html__ ( 'Add Icon', 'our-team-members' ) . '</a>';
		echo '<a href="#" class="button wpsf-warning-primary wpsf-icon-remove' . $hidden . '">' . esc_html__ ( 'Remove Icon', 'our-team-members' ) . '</a>';
