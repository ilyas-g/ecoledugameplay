...
class WPSFramework_Option_Gallery extends WPSFramework_Options {
	...
	public function output() {
		...
		$add = (! empty ( $this->field ['add_title'] )) ? $this->field ['add_title'] : esc_html__ ( 'Add Gallery', 'our-team-members' );
		$edit = (! empty ( $this->field ['edit_title'] )) ? $this->field ['edit_title'] : esc_html__ ( 'Edit Gallery', 'our-team-members' );
		$clear = (! empty ( $this->field ['clear_title'] )) ? $this->field ['clear_title'] : esc_html__ ( 'Clear', 'our-team-members' );
