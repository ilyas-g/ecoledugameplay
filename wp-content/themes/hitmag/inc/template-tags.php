...
if ( ! function_exists( 'hitmag_get_selected_breadcrumb' ) ) {
	/**
	 * Get the user selected breadcrumb
	 * 
	 * @since 1.4.0
	 */
	function hitmag_get_selected_breadcrumb() {
		$breadcrumb_source = get_theme_mod( 'hitmag_breadcrumb_source', 'none' );
...
if ( ! function_exists( 'hitmag_breadcrumb_template' ) ) {
	/**
	 * Adds the breadcrumb to the selected location
	 * 
	 * @since 1.4.0
	 */
	function hitmag_breadcrumb_template() {

		if ( 'none' === get_theme_mod( 'hitmag_breadcrumb_source', 'none' ) ) {
			return;
		}

		if ( 'before-entry-header' === get_theme_mod( 'hitmag_breadcrumb_location', 'before-entry-header' ) ) {
			if ( is_archive() || is_search() ) {
				add_action( 'hitmag_before_main_content', 'hitmag_hook_breadcrumb_location', 15 );
			} elseif ( is_singular() ) {
				add_action( 'hitmag_before_entry_header', 'hitmag_hook_breadcrumb_location', 15 );
			}
		} else {
			add_action( 'hitmag_after_header', 'hitmag_hook_breadcrumb_location', 15 );
		}

	}
	add_action( 'wp', 'hitmag_breadcrumb_template' );
}

if ( ! function_exists( 'hitmag_hook_breadcrumb_location' ) ) {
	/**
	 * Hook breadcrumb template to the selected location.
	 * 
	 * @since 1.4.0
	 */
	function hitmag_hook_breadcrumb_location() {
		$breadcrumb_location = get_theme_mod( 'hitmag_breadcrumb_location', 'before-entry-header' );
		...
		hitmag_get_selected_breadcrumb();
