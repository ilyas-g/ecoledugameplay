...
if ( ! class_exists( 'ilovewp_CSS' ) ) :
    ...
    class ilovewp_CSS {
        ...
        /**
         * The one instance of ilovewp_CSS.
         *
         * @var   ilovewp_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one ilovewp_CSS instance.
         *
         * @return ilovewp_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'ilovewp_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `ilovewp_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'ilovewp_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'ilovewp_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'ilovewp_get_css' ) ) :
    /**
     * Return the one ilovewp_CSS object.
     *
     * @return ilovewp_CSS    The one ilovewp_CSS object.
     */
    function ilovewp_get_css() {
        return ilovewp_CSS::instance();
    }
endif;

add_action( 'init', 'ilovewp_get_css', 1 );